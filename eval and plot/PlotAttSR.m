...
save_fig_path = 'D:\Datasets\LaSOT_Evaluation_Toolkit\attfig\';          % path to result figures
...
att_name ={'NO', 'PO', 'TO', 'HO', 'MB', 'LI', 'HI', ...
                 'AIV', 'LR', 'DEF', 'BC', 'SA', 'CM', 'TC','FL','OV','FM','SV',...
                 'ARC'
             };
att_fig_name  = {'NO', 'PO', 'TO', 'HO', 'MB', 'LI', 'HI', ...
                 'AIV', 'LR', 'DEF', 'BC', 'SA', 'CM', 'TC','FL','OV','FM','SV',...
                 'ARC'
                 };
