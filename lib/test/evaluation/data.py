...
class Sequence:
    ...
    def __init__(self, name, frames, frames_i,dataset, ground_truth_rect, ground_truth_seg=None, init_data=None,
                 object_class=None, target_visible=None, object_ids=None, multiobj_mode=False):
        self.name = name
        self.frames = frames
        self.frames_i=frames_i
    ...
    def _ensure_start_frame(self):
        ...
        if start_frame > 0:
            ...
            self.frames_i = self.frames_i[start_frame:]
