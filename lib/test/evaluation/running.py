...
def _save_tracker_output(seq: Sequence, tracker: Tracker, output: dict):
    ...
    base_results_path = os.path.join(tracker.results_dir.split('/tracking_results/')[0],seq.dataset,tracker.parameter_name, seq.name)
    if not os.path.exists(os.path.join(tracker.results_dir.split('/tracking_results/')[0],seq.dataset,tracker.parameter_name,)):
        os.makedirs(os.path.join(tracker.results_dir.split('/tracking_results/')[0],seq.dataset,tracker.parameter_name,))
