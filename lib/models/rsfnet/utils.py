...
def combine_tokens(template_tokens, t2,t3,t1i,t2i,t3i,search_tokens,si, mode='direct', return_res=False):
    # [B, HW, C]
    len_t = template_tokens.shape[1]
    len_s = search_tokens.shape[1]

    if mode == 'direct':
        merged_feature = torch.cat((template_tokens, t2,t3,t1i,t2i,t3i,search_tokens,si), dim=1)
